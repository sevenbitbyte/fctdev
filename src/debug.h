...
#if PRINT_ENABLE
	#define PRINT_MSG(msg) cout<<__PRETTY_FUNCTION__<<" - "<<msg
#else
...
#if DEBUG_ENABLE
	#define DEBUG_MSG(msg) cout<<__PRETTY_FUNCTION__<<" - DEBUG, "<<msg
#else
