...
class CI_DB_driver {
	...
	/*
	echo "<PRE>";
		var_dump($this->_protect_identifiers($table_name, TRUE, FALSE, FALSE));
		var_dump($this->list_tables());
		var_dump(in_array($this->_protect_identifiers($table_name, TRUE, FALSE, FALSE), $this->list_tables()));
		*/
